...
namespace CityInfo.API.Businsess_Layer.Services
{
    public class CityInfoRepository : ICityInfoRepository
    {
        ...
        public async Task<(IEnumerable<City>, PaginationMetadata)> GetCityAsync(string? name, string? searchQuery, int pageNumber, int pageSize)
        {
        ...
        public async Task<City?> GetCityAsync(int cityId, bool includePointOfInteres)
        {
            if (includePointOfInteres)
            {
